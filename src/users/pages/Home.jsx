      ...
      <div className='bg-neutral-950'>
        ...
        <section className="relative h-screen flex flex-col md:flex-row items-center justify-center  overflow-hidden px-6 md:px-16">
          ...
          <div className="relative z-10 flex-1 flex flex-col items-start gap-6  " ref={containerRef}>
            ...
            <h1 id='chillax' className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extralight text-neutral-900 leading-tight uppercase">
              YOUR <span className="text-red-500">VISION,</span><br />IMPOSSIBLE TO IGNORE.
            </h1>
            ...
            <div className="flex gap-4">
              <a
                href="/hire-me"
                className="px-8 py-3 rounded-full bg-red-800 text-white hover:bg-red-700 transition-all duration-300 font-semibold"
              >
                Get Started
              </a>
              <a
                href="/work"
                className="px-8 py-3 rounded-full border-2 border-red-800 text-red-800 hover:bg-red-800 hover:text-white transition-all duration-300 font-semibold"
              >
                See Work
              </a>
            </div>
        ...
        {/* section 2 */}
        <div className="flex flex-col md:flex-row h-210 border border-neutral-200  bg-neutral-200/50 w-400 ms-10 rounded-4xl bg-neutral-00">
          {/* Left Side - Image with Overlay */}
          <div className="relative w-full md:w-1/2 border-b rounded-4xl border-neutral-300  h-210 overf">
            {/* Background Image */}
            <div
              className="absolute inset-0 bg-cover  border border-neutral-200 rounded-md bg-center"
              style={{
          ...
          <div style={{
            ...
            <div
              ...
              <div id='chillax' className="section2-words ">
                <h1 className="text-4xl md:text-4xl lg:text-4xl text-start font-extralight me-5  ms-5 leading-normal rounded-lg  text-black">
                  {splitWords(
        ...
        {/* section 3 */}
        <div ref={section3Ref} className='flex-col bg-neutral-300/20 border-neutral-200 border  gap-5 mt-10 w-400 h-170 mb-10 ms-10 rounded-4xl p-5 overflow-hidden'>
          <h1 className='text-3xl sm:text-4xl md:text-8xl  font-extralight px-5 md:px-10 py-5 text-neutral-900 mt-5'>Our services</h1> <hr className='mt-6 md:mt-2 text-neutral-500 ms-5 md:ms-10 mr-15' />
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mt-10 px-5 md:px-10'>
              ...
              <div className="p-8 rounded-2xl   max-w-sm text-left">
                <div className="flex  items-center mb-4">
                  <div className="flex  items-center justify-center w-10 h-10 bg-white/10 rounded-full">
                    <i className="fa-solid fa-star text-black text-xl"></i>
                  </div>
                </div>
                <h2 className="text-2xl font-semibold text-black mb-2">Freelance</h2>
            ...
            <SpotlightCard className="custom-spotlight-card" spotlightColor="rgba(0, 191, 255, 0.4)">
              <div className="p-8 rounded-2xl   max-w-sm text-left">
                <div className="flex items-center mb-4">
                  <div className="flex items-center justify-center w-10 h-10 bg-white/10 rounded-full">
                    <i className="fa-solid  text-black text-xl fa-earth-asia"></i>
                  </div>
                </div>
                <h2 className="text-2xl font-semibold text-black mb-2">Web Development</h2>
                <p className="text-gray-400 text-sm leading-relaxed">
            ...
            <SpotlightCard className="custom-spotlight-card" spotlightColor="rgba(255, 105, 180, 0.4)">
              <div className="p-8 rounded-2xl   max-w-sm text-left">
                ...
                <h2 className="text-2xl font-semibold text-black mb-2">Video Editing</h2>
                <p className="text-gray-400 text-sm leading-relaxed">
            ...
            <SpotlightCard className="custom-spotlight-card" spotlightColor="rgba(144, 238, 144, 0.4)">
              <div className="p-8 rounded-2xl   max-w-sm text-left">
                <div className="flex items-center mb-4">
                  <div className="flex items-center justify-center w-10 h-10 bg-white/10 rounded-full">
                    <i className="fa-solid fa-code text-black text-xl"></i>
                  </div>
                </div>
                <h2 className="text-2xl font-semibold text-black mb-2">Software Development</h2>
                <p className="text-gray-400 text-sm leading-relaxed">
            ...
            <SpotlightCard className="custom-spotlight-card" spotlightColor="rgba(255, 140, 0, 0.4)">
              <div className="p-8 rounded-2xl   max-w-sm text-left">
                <div className="flex items-center mb-4">
                  <div className="flex items-center justify-center w-10 h-10 bg-white/10 rounded-full">
                    <i className="fa-solid fa-ranking-star text-black text-xl"></i>
                  </div>
                </div>
                <h2 className="text-2xl font-semibold text-black mb-2">SEO</h2>
                <p className="text-gray-400 text-sm leading-relaxed">
